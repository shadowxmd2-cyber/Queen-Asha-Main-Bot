...
async function connectToWA() {
  ...
  console.log("Connecting Queen Asha MD");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("Queen Asha MD installed successful ✅");
      console.log("Queen Asha MD connected to whatsapp ✅");

      let up = `Queen Asha MD connected successful ✅`;
      let up1 = `😱 Hello Kavindu, I made bot successful 👸`;
      ...
      robin.sendMessage("94770051298@s.whatsapp.net", {
        image: {
          url: `https://files.catbox.moe/oaex2l.jpg`,
        },
        caption: up1,
